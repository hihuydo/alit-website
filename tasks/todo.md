...
- [ ] **DK-10** i18n-Strings unter `dashboardStrings.exportModal.*` (12 keys, incl. tablistLabel + imageCountDisabledLayoutMode).
- [ ] **DK-11** Vitest-Integration-Tests in `InstagramExportModal.test.tsx` (NEU, 12 cases mit mocked LayoutEditor + globaler fetch-stub).
...
- [ ] Vitest 12 neue Tests + bestehende 961 alle grün
