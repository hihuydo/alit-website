...
<!-- R9 (2026-05-01): R8-fixes erzeugten neue Drift. R9 fixes: (P1) explicit displayState/payloadState separation, (P1) re-snapshot post-save mergeWithDefaults(response.data), (P2) GET-route-test asserts raw not defaults, (P2) DK-11 reset-semantics consistent with stripDictEqual (DB stays minimal, public falls back). Drift: 32→30 fields. Plus mergeWithDefaults + stripDictEqual als pure helpers in submission-form-fields.ts spec'd. -->
