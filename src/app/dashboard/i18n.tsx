...
export const dashboardStrings = {
  ...
  leiste: {
    tabLabel: "Beschriftungen",
    sectionHeading: "Beschriftungen",
    sectionIntro: "Hier kannst du die Beschriftungen der Spalten-Überschriften und der Navigation anpassen. Leer lassen, um den Standardwert zu verwenden.",
    heading: "Spalten-Überschriften",
    intro: "Diese Texte erscheinen als Spalten-Überschriften auf der Website.",
  ...
  nav: {
    heading: "Navigation",
    intro: "Diese Texte erscheinen in der Navigationsleiste der Website.",
    fieldAgenda: "Agenda",
    fieldProjekte: "Projekte",
    fieldAlit: "Über Alit",
    fieldMitgliedschaft: "Mitgliedschaft",
    fieldNewsletter: "Newsletter",
  },
} as const;
