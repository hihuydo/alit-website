...
export async function POST(req: NextRequest) {
  ...
  const { slug_de, slug_fr, title_i18n, kategorie_i18n, content_i18n, archived, show_newsletter_signup } = body;
  ...
  try {
    ...
    const { rows } = await client.query(
      `INSERT INTO projekte (slug_de, slug_fr, archived, sort_order, title_i18n, kategorie_i18n, content_i18n, show_newsletter_signup)
       VALUES ($1, $2, $3, (SELECT COALESCE(MAX(sort_order), -1) + 1 FROM projekte), $4, $5, $6, $7)
       RETURNING *`,
      [
        slug_de,
        slugFrNormalized,
