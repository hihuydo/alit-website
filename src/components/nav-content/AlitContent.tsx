export function AlitContent() {
  return (
    <>
      <p>Alit – Netzwerk für Literatur ist ein selbständiger Verein mit Sitz in Zürich. Der Verein fördert die Produktion und Distribution von Literatur aus der Schweiz und vermittelt das vielfältige literarische Schaffen durch Publikationen, Veranstaltungen, Debatten und Vernetzung einem breiten interessierten Publikum.</p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>Alit ist eine Autor:inneninitiative, orientiert sich an den Bedürfnissen der Literaturschaffenden und initiiert Projekte. Der Verein engagiert sich für Texte, die von Verlagen aus ökonomischen Gründen nicht publiziert werden, beispielsweise in den Gattungen Lyrik, Dramatik und Essay und von nicht-landessprachigen oder vergessenen Schweizer Autor:innen. Mit seiner Tätigkeit reagiert der Verein auf die derzeitigen Entwicklungen in der Medienlandschaft und auf dem Buchmarkt und versucht, Lücken in der aktuellen Literaturförderung schliessen zu helfen.</p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>2021 lancierte Alit die Initiative <strong>«Zukunft Literatur Schweiz 1945–2045 | 100 Jahre neuere Schweizer Literaturen».</strong></p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>Im Rahmen dieser Initiative führte der Verein drei neue Programme ein:</p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>Erstens das Programm «Sichtbarmachung», in dem zusammen mit Autor:innen neue Fördermöglichkeiten erarbeitet werden, um die Sichtbarkeit heute entstehender Texte zu erhöhen.</p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>Zweitens das Programm «Kulturelles Gedächtnis», das Texte von herausragender ästhetischer Qualität, die nach 1945 entstanden sind, lieferbar erhalten und zeigen will, dass sie auch wichtige Quellen sind für das Verständnis von Entwicklungen in den Bereichen Kultur, Gesellschaft und Politik.</p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>Und drittens das Programm «Vermittlung», das Projekte unterstützt, die die Vernetzung und den Austausch zwischen Literaturen der Schweiz und internationalen Literaturentwicklungen deutlich machen und einer breiteren Öffentlichkeit vermitteln.</p>

      <p style={{ paddingTop: "var(--spacing-content-top)" }}>Alit wirkt in Ergänzung zu Schweizer Institutionen mit verwandtem Zweck. Der Verein kann also bestehende Fördergefässe ergänzen. Er versteht sich als Partner von Literaturveranstaltern, Verlagen, Universitäten, Schulen und Archiven. Alit möchte die Initiative «Zukunft Literatur Schweiz 1945–2045 | 100 Jahre neuere Schweizer Literaturen» langfristig aufbauen und strebt Nachhaltigkeit an.</p>
